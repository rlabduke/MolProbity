...
if [ ! -f cbflib.tar.gz ]; then curl 'http://downloads.sourceforge.net/project/cbflib/cbflib/CBFlib_0.9.5/CBFlib-0.9.5.11.tar.gz?r=&ts=1440424898' -o cbflib.tar.gz; fi
