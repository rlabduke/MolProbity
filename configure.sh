...
if [ ! -f cbflib.tar.gz ]; then curl 'http://downloads.sourceforge.net/project/cbflib/cbflib/CBFlib_0.9.5/CBFlib-0.9.5.11.tar.gz?r=http%3A%2F%2Fsourceforge.net%2Fprojects%2Fcbflib%2Ffiles%2Fcbflib%2FCBFlib_0.9.5%2F&ts=1440424361&use_mirror=netcologne' -o cbflib.tar.gz; fi
