...
$mpc_table = mpUnserialize($data);
fclose($in);
$modelID1 = $_REQUEST['model1'];
$modelID2 = $_REQUEST['model2'];

$frame = get_mpc_sbs_chart(
  $mpc_t = $mpc_table, 
...
if(isset($_REQUEST['key']))
  echo str_replace("&aring;", "&Aring;", $frame['key']);
if(isset($_REQUEST['table']))
  echo str_replace("&aring;", "&Aring;", $frame['table']);
?>
</body>
</html>
