...
if ($Smotif){
	if ($suitestring =~ /5z4s#a/) {
		print "Smotif found!\nYour structure contains Smotifs. Please refer to the suitename file and look for consecutive residues with 5z,4s, and #a\n";
		
	}
	else {print "No Smotifs were found in this structure. Better luck next time.";}
}
