...
class motif_search_delegate extends BasicDelegate {
...
{
    echo $this->pageHeader("Motif Search");
...
function setAnalyses(doAAC, hasProtein, hasNucAcid, isBig)
{
    ...
    document.forms[0].Smotif.checked        = hasNucAcid
    document.forms[0].GNRA.checked        = hasNucAcid
...
<h5 class='nospaceafter'><label><input type='checkbox' name='doKinemage' value='1' checked onclick='hideKinOpts()'> 3-D kinemage graphics</label></h5>
    ...
    <label><input type='checkbox' name='kinSmotif' value='1'> Smotif</label>
    <br><label><input type='checkbox' name='kinGNRA' value='1'> GNRA</label>
    </div>
<h5 class='nospaceafter'><label><input type='checkbox' name='doCharts' value='1' checked onclick='hideChartOpts()'> Charts, plots, and tables</label></h5>
    ...
    <label><input type='checkbox' name='chartSmotif' value='1'> Smotif</label>
    <br><label><input type='checkbox' name='chartGNRA' value='1'> GNRA</label>
    </div>
    </div>
</div>
<?php
...
function onRunAnalysis()
{
    ...
    if(isset($req['modelID']))
    {
        ...
        if($req['chartSmotif'] || $req['chartGNRA'] )
        	mpLog("aacgeom:Searching for motifs");
