...
<?php
    echo "    <param name='pdbSource' value='$url'>\n";
...
else echo "<a href='viewpdbking.php?$_SESSION[sessTag]&url=$url&size=tiny'>tiny</a>";
echo " | ";
if($kingSize == "small") echo "small";
else echo "<a href='viewpdbking.php?$_SESSION[sessTag]&url=$url&size=small'>small</a>";
echo " | ";
if($kingSize == "default") echo "default";
else echo "<a href='viewpdbking.php?$_SESSION[sessTag]&url=$url&size=default'>default</a>";
echo " | ";
if($kingSize == "large") echo "large";
else echo "<a href='viewpdbking.php?$_SESSION[sessTag]&url=$url&size=large'>large</a>";
echo " | ";
if($kingSize == "huge") echo "huge";
else echo "<a href='viewpdbking.php?$_SESSION[sessTag]&url=$url&size=huge'>huge</a>";
?>
</td>
</tr></table>
</form>
